...
ADriveVisionSportsCar::ADriveVisionSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UDriveVisionSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UDriveVisionSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UDriveVisionSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UDriveVisionSportsWheelRear::StaticClass();
